class CartsController < ApplicationController
  ...
  def create
    soccer_fielded = OrderDetail.find_by soccer_field_id: params[:soccer_field_id],
                     booking_used: params[:time], type_field: params[:type], order_date: params[:date]
